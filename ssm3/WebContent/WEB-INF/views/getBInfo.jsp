...
<div class = "osu-page osu-page--beatmapsets-search-header ">
    <form method="get" action="${pageContext.request.contextPath}/book/bookInfo">
               ...
               <input type="text" name="title" class ="beatmapsets-search__input beatmapsets-search__input-container" placeholder="输入书名..." style ="padding: 10px 15px 10px 10px;">
               </div>
               <div class = "beatmapsets-search-filter">
               		...
               		<a href="${pageContext.request.contextPath}/book/bookInfo?kind=课本教材" class="beatmapsets-search-filter__item" data-filter-value="kind">课本教材</a>
               		<a href="${pageContext.request.contextPath}/book/bookInfo?kind=课本教材" class="beatmapsets-search-filter__item" data-filter-value="kind">课本教材</a>
               		<a href="${pageContext.request.contextPath}/book/bookInfo?kind=课本教材" class="beatmapsets-search-filter__item" data-filter-value="kind">课本教材</a>
               		<a href="${pageContext.request.contextPath}/book/bookInfo?kind=课本教材" class="beatmapsets-search-filter__item" data-filter-value="kind">课本教材</a>
               		<a href="${pageContext.request.contextPath}/book/bookInfo?kind=课本教材" class="beatmapsets-search-filter__item" data-filter-value="kind">课本教材</a>
